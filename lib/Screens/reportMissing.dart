      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              Container(
                margin: dispButton ? EdgeInsets.only(top: 40, bottom: 30) : null,
                child: dispButton ?
                FlatButton(
                ...
                Flexible (child: Image.file(File(_image), width: 300, height: 300,)),
              ),
              TextField(
              ...
              FlatButton(
                ...
                onPressed: () {
                  setState(() {
                    nameController.text.isEmpty ? _empty = true : _empty = false;
                    if(! _empty)
                      dispButton = true;
                  });
                  if(! _empty) {
